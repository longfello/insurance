 ...
 * Time: 17:03
 */
namespace common\components\Calculator\widgets\mortgage;

use common\components\Calculator\forms\TravelForm;
use yii\bootstrap\Widget;

/**
 * Class CalculatorWidget Калькулятор Ипотечное страхование
 * @package common\components\Calculator\widgets\mortgage
 */
