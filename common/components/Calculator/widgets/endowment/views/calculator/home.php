  ...
  <div class="filter insurance-find__filter">
    ...
    <div class="filter__invest-life">
        ...
        <div class="form-group">
            <input name="insurance-sum" class="input input_size_m form-control" type="text">
        </div>
    </div>
...
<div class="insurance-image insurance-image_endowment insurance-image_endowment_calc">
    <img src="/img/filter-endowment-insurance_calc.png">
</div>