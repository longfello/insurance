 ...
 * Time: 17:03
 */
namespace common\components\Calculator\widgets\investment;

use common\components\Calculator\forms\TravelForm;
use yii\bootstrap\Widget;

/**
 * Class CalculatorWidget Калькулятор Накопительное страхование жизни
 * @package common\components\Calculator\widgets\investment
 */
