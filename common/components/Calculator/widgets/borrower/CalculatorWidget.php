 ...
 * Time: 17:03
 */
namespace common\components\Calculator\widgets\borrower;

use common\components\Calculator\forms\TravelForm;
use yii\bootstrap\Widget;

/**
 * Class CalculatorWidget Калькулятор Страхование жизни ипотечного заемщика
 * @package common\components\Calculator\widgets\borrower
 */
