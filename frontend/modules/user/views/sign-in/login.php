    ...
    <div class="row">
        <div class="col-lg-5">
            <?php $form = ActiveForm::begin(['id' => 'login-form']); ?>
                ...
                <div class="form-group">
                    <?php echo Html::a(Yii::t('frontend', 'Need an account? Sign up.'), ['/user/sign-in/signup']) ?>
                </div>
            <div class="form-group">
                <?php echo Html::a(Yii::t('frontend', 'Регистрация для агенства'), ['/agency/sign-in/signup']) ?>
            </div>
