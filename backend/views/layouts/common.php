        ...
        <header class="main-header">
            ...
            <nav class="navbar navbar-static-top" role="navigation">
                ...
                <div class="navbar-custom-menu">
                        ...
                        <li>
                            <?= Yii::$app->user->can('administrator')?Html::a('<i class="fa fa-cogs"></i>', ['/site/settings']):""; ?>
                        </li>
                    </ul>
                </div>
            </nav>
            ...
            <section class="sidebar">
                ...
                <?php
                    if (Yii::$app->user->can("administrator")){
                        echo $this->render("menus/administrator");
                    } elseif (Yii::$app->user->can("manager")){
                        echo $this->render("menus/administrator");
                    } elseif (Yii::$app->user->can("user")){
                        echo $this->render("menus/user");
                    } elseif (Yii::$app->user->can("api_user")){
                        echo $this->render("menus/api_user");
                    } elseif (Yii::$app->user->can("test_api_user")){
                        echo $this->render("menus/api_user");
                    }
                 ?>
            </section>
