...
use common\modules\ApiErv\models\Program2Risk;
use Yii;
...
/**
 * ErvProgramController implements the CRUD actions for Program model.
 */
class ErvProgramController extends Controller
{
    /**
     * @inheritdoc
     */
